...
const STEPS = [
    {
        ...
        body: 'Pick a time that suits you and share the three coordinates the sky needs — date, time and place of birth — for yourself, or up to four people. No payment is taken upfront.',
        points: [
            'Date, time & place of birth',
            'Up to 4 people in one booking',
            'Nothing to pay yet',
        ],
    },
    {
